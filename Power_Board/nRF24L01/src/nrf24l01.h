 ...
 *
 * Modified by: Jonathan Bruce for dspic33e
 *
 *****************************************************************************/
...
#define nrf24l01_CE_PINMASK		0b000001    // Pin RA7
...
#define nrf24l01_CSN_PINMASK		0b1         // Pin RB0

//defines for uC pins IRQ pin is connected to
//This is used so that the routines can poll for IRQ or create an ISR.
//Change these definitions (and then recompile) to suit your particular application.
#define nrf24l01_IRQ_IOREGISTER		PORTG
#define nrf24l01_IRQ_PINMASK		0b00001     // Pin RG9
