...
extern "C"
{
    ...
    //extern ECAN2MSGBUF  ecan2msgBuf __attribute__((space(eds)));
        #ifdef _HAS_DMA_
    ...
    //extern __eds__ unsigned int ecan2msgBuf[ECAN2_MSG_BUF_LENGTH][8]  __attribute__((space(eds),aligned(ECAN2_MSG_BUF_LENGTH*16)));
    // *****************************************************************************
    // *****************************************************************************
