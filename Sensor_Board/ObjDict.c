...
const indextable * Sensor_Board_scanIndexOD (UNS16 wIndex, UNS32 * errorCode, ODCallback_t **callbacks)
{
	...
	*callbacks = NULL;
	switch(wIndex){
		...
		case 0x1800: i = 14;*callbacks = Sensor_Board_Index1800_callbacks; break;
		case 0x1801: i = 15;*callbacks = Sensor_Board_Index1801_callbacks; break;
		case 0x1802: i = 16;*callbacks = Sensor_Board_Index1802_callbacks; break;
		case 0x1803: i = 17;*callbacks = Sensor_Board_Index1803_callbacks; break;
