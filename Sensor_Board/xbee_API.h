...
#define LENGTH_XBEE_API_HEADER                  LENGTH_XBEE_START_DELIMITER+LENGTH_XBEE_API_LENGTH+LENGTH_XBEE_API_ID+LENGTH_XBEE_FRAMEID+LENGTH_XBEE_CHECKSUM

// Definiton of AT header lengths
#define LENGTH_XBEE_API_ATCMD                   2
#define LENGTH_XBEE_AT_FRAME_NOPARAM            LENGTH_XBEE_API_HEADER+LENGTH_XBEE_API_ATCMD
...
#define LENGTH_XBEE_IPv4_FRAME_NODATA           LENGTH_XBEE_API_HEADER+LENGTH_XBEE_IPv4_DESTINATION_ADDRESS+LENGTH_XBEE_IPv4_DESTINATION_PORT+LENGTH_XBEE_IPv4_SOURCE_PORT+LENGTH_XBEE_IPv4_PROTOCOL+LENGTH_XBEE_IPv4_OPTIONS
